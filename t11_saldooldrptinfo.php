...
//
// Table class for t11_saldoold
//
class crt11_saldoold extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 't11_saldoold';
		$this->TableName = 't11_saldoold';
		...
		// id
		$this->id = new crField('t11_saldoold', 't11_saldoold', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// Bulan
		$this->Bulan = new crField('t11_saldoold', 't11_saldoold', 'x_Bulan', 'Bulan', '`Bulan`', 16, EWR_DATATYPE_NUMBER, -1);
		...
		// Tahun
		$this->Tahun = new crField('t11_saldoold', 't11_saldoold', 'x_Tahun', 'Tahun', '`Tahun`', 2, EWR_DATATYPE_NUMBER, -1);
		...
		// Jumlah
		$this->Jumlah = new crField('t11_saldoold', 't11_saldoold', 'x_Jumlah', 'Jumlah', '`Jumlah`', 4, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t11_saldoold`";
	}
