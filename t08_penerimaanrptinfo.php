...
//
class crt08_penerimaan extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('t08_penerimaan', 't08_penerimaan', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// NoKwitansi
		$this->NoKwitansi = new crField('t08_penerimaan', 't08_penerimaan', 'x_NoKwitansi', 'NoKwitansi', '`NoKwitansi`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Keterangan
		$this->Keterangan = new crField('t08_penerimaan', 't08_penerimaan', 'x_Keterangan', 'Keterangan', '`Keterangan`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Jumlah
		$this->Jumlah = new crField('t08_penerimaan', 't08_penerimaan', 'x_Jumlah', 'Jumlah', '`Jumlah`', 4, EWR_DATATYPE_NUMBER, -1);
