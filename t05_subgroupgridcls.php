...
$t05_subgroup_grid = NULL; // Initialize page object first

class ct05_subgroup_grid extends ct05_subgroup {
	...
	// Page object name
	var $PageObjName = 't05_subgroup_grid';

	// Grid form hidden field names
	var $FormName = 'ft05_subgroupgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t05_subgroup"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->maingroup_id->getSessionValue() <> "") {
			$rsnew['maingroup_id'] = $this->maingroup_id->getSessionValue();
		}
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "t04_maingroup") {
			$this->maingroup_id->Visible = FALSE;
			if ($GLOBALS["t04_maingroup"]->EventCancelled) $this->EventCancelled = TRUE;
		}
