...
//
// Table class for t03_barang
//
class ct03_barang extends cTable {
	var $id;
	var $Nama;
	var $satuan_id;
	...
	function __construct() {
		...
		$this->TableVar = 't03_barang';
		$this->TableName = 't03_barang';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t03_barang`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t03_barang', 't03_barang', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Nama
		$this->Nama = new cField('t03_barang', 't03_barang', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t03_barang`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t03_barangedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t03_barangadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t03_barangview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t03_barangview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t03_barangadd.php?" . $this->UrlParm($parm);
		else
			$url = "t03_barangadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t03_barangedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t03_barangadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t03_barangdelete.php", $this->UrlParm());
	}
