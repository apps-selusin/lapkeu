...
<?php if (!isset($t99_audittrail_view->Pager)) $t99_audittrail_view->Pager = new cPrevNextPager($t99_audittrail_view->StartRec, $t99_audittrail_view->DisplayRecs, $t99_audittrail_view->TotalRecs, $t99_audittrail_view->AutoHidePager) ?>
