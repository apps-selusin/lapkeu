...
//
class crt05_subgroup extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('t05_subgroup', 't05_subgroup', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// maingroup_id
		$this->maingroup_id = new crField('t05_subgroup', 't05_subgroup', 'x_maingroup_id', 'maingroup_id', '`maingroup_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// maingroup_nama
		$this->maingroup_nama = new crField('t05_subgroup', 't05_subgroup', 'x_maingroup_nama', 'maingroup_nama', '(select nama from t04_maingroup a where a.id = maingroup_id)', 200, EWR_DATATYPE_STRING, -1);
		...
		// Nama
		$this->Nama = new crField('t05_subgroup', 't05_subgroup', 'x_Nama', 'Nama', '`Nama`', 200, EWR_DATATYPE_STRING, -1);
