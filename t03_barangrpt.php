...
<?php include_once "t03_barangrptinfo.php" ?>
<?php
...
$t03_barang_rpt = NULL; // Initialize page object first

class crt03_barang_rpt extends crt03_barang {
	...
	// Page object name
	var $PageObjName = 't03_barang_rpt';
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 't03_barang', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ft03_barangrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't03_barang');
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_t03_barang\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_t03_barang',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ft03_barangrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ft03_barangrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ft03_barangrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[2] = $this->satuan_nama->CurrentValue;
		} else {
			$this->id->setDbValue("");
...
// Create page object
if (!isset($t03_barang_rpt)) $t03_barang_rpt = new crt03_barang_rpt();
...
// Create page object
var t03_barang_rpt = new ewr_Page("t03_barang_rpt");

// Page properties
t03_barang_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = t03_barang_rpt.PageID;
</script>
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_t03_barang" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Nama"><div class="t03_barang_Nama"><span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Nama">
<?php if ($Page->SortUrl($Page->Nama) == "") { ?>
		<div class="ewTableHeaderBtn t03_barang_Nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t03_barang_Nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="satuan_nama"><div class="t03_barang_satuan_nama"><span class="ewTableHeaderCaption"><?php echo $Page->satuan_nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="satuan_nama">
<?php if ($Page->SortUrl($Page->satuan_nama) == "") { ?>
		<div class="ewTableHeaderBtn t03_barang_satuan_nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->satuan_nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t03_barang_satuan_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->satuan_nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->satuan_nama->FldCaption() ?></span>
...
<span<?php echo $Page->satuan_nama->ViewAttributes() ?>><?php echo $Page->satuan_nama->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "t03_barangrptpager.php" ?>
