...
//
// Table class for t09_periode
//
class ct09_periode extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't09_periode';
		$this->TableName = 't09_periode';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t09_periode`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t09_periode', 't09_periode', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Bulan
		$this->Bulan = new cField('t09_periode', 't09_periode', 'x_Bulan', 'Bulan', '`Bulan`', '`Bulan`', 16, -1, FALSE, '`Bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tahun
		$this->Tahun = new cField('t09_periode', 't09_periode', 'x_Tahun', 'Tahun', '`Tahun`', '`Tahun`', 2, -1, FALSE, '`Tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t09_periode`";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "t09_periodeview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "t09_periodeedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t09_periodeadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t09_periodeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t09_periodeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t09_periodeadd.php?" . $this->UrlParm($parm);
		else
			$url = "t09_periodeadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t09_periodeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t09_periodeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t09_periodedelete.php", $this->UrlParm());
	}
