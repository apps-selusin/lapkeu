...
class ct04_maingroup extends cTable {
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "t05_subgroup") {
			$sDetailUrl = $GLOBALS["t05_subgroup"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "t04_maingrouplist.php";
		}
		return $sDetailUrl;
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			...
			$url = $this->KeyUrl("t04_maingroupedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			...
			$url = $this->KeyUrl("t04_maingroupadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
