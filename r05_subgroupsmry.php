...
<?php include_once "r05_subgroupsmryinfo.php" ?>
<?php
...
$r05_subgroup_summary = NULL; // Initialize page object first

class crr05_subgroup_summary extends crr05_subgroup {
	...
	// Page object name
	var $PageObjName = 'r05_subgroup_summary';
	...
	function __construct() {
		...
		// Table object (r05_subgroup)
		if (!isset($GLOBALS["r05_subgroup"])) {
			$GLOBALS["r05_subgroup"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["r05_subgroup"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'r05_subgroup', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fr05_subgroupsummary";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'r05_subgroup');
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_r05_subgroup\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_r05_subgroup',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fr05_subgroupsummary\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fr05_subgroupsummary\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fr05_subgroupsummary\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($r05_subgroup_summary)) $r05_subgroup_summary = new crr05_subgroup_summary();
if (isset($Page)) $OldPage = $Page;
$Page = &$r05_subgroup_summary;
...
// Create page object
var r05_subgroup_summary = new ewr_Page("r05_subgroup_summary");

// Page properties
r05_subgroup_summary.PageID = "summary"; // Page ID
var EWR_PAGE_ID = r05_subgroup_summary.PageID;
</script>
<?php } ?>
...
<?php include "r05_subgroupsmrypager.php" ?>
...
<?php } ?>
<span data-class="tpb<?php echo $Page->GrpCount-1 ?>_r05_subgroup"><?php echo $Page->PageBreakContent ?></span>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_r05_subgroup" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="maingroup_nama"><div class="r05_subgroup_maingroup_nama"><span class="ewTableHeaderCaption"><?php echo $Page->maingroup_nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="maingroup_nama">
<?php if ($Page->SortUrl($Page->maingroup_nama) == "") { ?>
		<div class="ewTableHeaderBtn r05_subgroup_maingroup_nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->maingroup_nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r05_subgroup_maingroup_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->maingroup_nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->maingroup_nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Nama"><div class="r05_subgroup_Nama"><span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Nama">
<?php if ($Page->SortUrl($Page->Nama) == "") { ?>
		<div class="ewTableHeaderBtn r05_subgroup_Nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r05_subgroup_Nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ewSummaryCaption r05_subgroup_maingroup_nama"><span class="ewTableHeaderCaption"><?php echo $Page->maingroup_nama->FldCaption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->SortUrl($Page->maingroup_nama) == "") { ?>
		<span class="ewSummaryCaption r05_subgroup_maingroup_nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->maingroup_nama->FldCaption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r05_subgroup_maingroup_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->maingroup_nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->maingroup_nama->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->maingroup_nama->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->maingroup_nama->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r05_subgroup_maingroup_nama"<?php echo $Page->maingroup_nama->ViewAttributes() ?>><?php echo $Page->maingroup_nama->GroupViewValue ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r05_subgroup_maingroup_nama"<?php echo $Page->maingroup_nama->ViewAttributes() ?>><?php echo $Page->maingroup_nama->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->Nama->Visible) { ?>
