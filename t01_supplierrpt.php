...
<?php include_once "t01_supplierrptinfo.php" ?>
<?php
...
$t01_supplier_rpt = NULL; // Initialize page object first

class crt01_supplier_rpt extends crt01_supplier {
	...
	// Page object name
	var $PageObjName = 't01_supplier_rpt';
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 't01_supplier', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ft01_supplierrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't01_supplier');
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_t01_supplier\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_t01_supplier',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ft01_supplierrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ft01_supplierrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ft01_supplierrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($t01_supplier_rpt)) $t01_supplier_rpt = new crt01_supplier_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$t01_supplier_rpt;
...
// Create page object
var t01_supplier_rpt = new ewr_Page("t01_supplier_rpt");

// Page properties
t01_supplier_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = t01_supplier_rpt.PageID;
</script>
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_t01_supplier" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Nama"><div class="t01_supplier_Nama"><span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Nama">
<?php if ($Page->SortUrl($Page->Nama) == "") { ?>
		<div class="ewTableHeaderBtn t01_supplier_Nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t01_supplier_Nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Alamat"><div class="t01_supplier_Alamat"><span class="ewTableHeaderCaption"><?php echo $Page->Alamat->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Alamat">
<?php if ($Page->SortUrl($Page->Alamat) == "") { ?>
		<div class="ewTableHeaderBtn t01_supplier_Alamat">
			<span class="ewTableHeaderCaption"><?php echo $Page->Alamat->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t01_supplier_Alamat" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Alamat) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Alamat->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="NoTelpHp"><div class="t01_supplier_NoTelpHp"><span class="ewTableHeaderCaption"><?php echo $Page->NoTelpHp->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="NoTelpHp">
<?php if ($Page->SortUrl($Page->NoTelpHp) == "") { ?>
		<div class="ewTableHeaderBtn t01_supplier_NoTelpHp">
			<span class="ewTableHeaderCaption"><?php echo $Page->NoTelpHp->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t01_supplier_NoTelpHp" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->NoTelpHp) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->NoTelpHp->FldCaption() ?></span>
...
<?php include "t01_supplierrptpager.php" ?>
