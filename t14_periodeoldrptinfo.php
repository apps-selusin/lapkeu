...
//
// Table class for t14_periodeold
//
class crt14_periodeold extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 't14_periodeold';
		$this->TableName = 't14_periodeold';
		...
		// id
		$this->id = new crField('t14_periodeold', 't14_periodeold', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// Bulan
		$this->Bulan = new crField('t14_periodeold', 't14_periodeold', 'x_Bulan', 'Bulan', '`Bulan`', 16, EWR_DATATYPE_NUMBER, -1);
		...
		// Tahun
		$this->Tahun = new crField('t14_periodeold', 't14_periodeold', 'x_Tahun', 'Tahun', '`Tahun`', 2, EWR_DATATYPE_NUMBER, -1);
		...
		// NamaBulan
		$this->NamaBulan = new crField('t14_periodeold', 't14_periodeold', 'x_NamaBulan', 'NamaBulan', '`NamaBulan`', 200, EWR_DATATYPE_STRING, -1);
		$this->NamaBulan->Sortable = TRUE; // Allow sort
		$this->NamaBulan->DateFilter = "";
		$this->NamaBulan->SqlSelect = "";
		$this->NamaBulan->SqlOrderBy = "";
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t14_periodeold`";
	}
