...
$t07_sekolah_Logo_blobview = NULL; // Initialize page object first

class ct07_sekolah_Logo_blobview extends ct07_sekolah {
	...
	// Page object name
	var $PageObjName = 't07_sekolah_Logo_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 't07_sekolah');
	...
	function Page_Main() {
		...
		// SQL constructor in t07_sekolah class, t07_sekolahinfo.php
...
// Create page object
if (!isset($t07_sekolah_Logo_blobview)) $t07_sekolah_Logo_blobview = new ct07_sekolah_Logo_blobview();

// Page init
$t07_sekolah_Logo_blobview->Page_Init();

// Page main
$t07_sekolah_Logo_blobview->Page_Main();
?>
<?php
$t07_sekolah_Logo_blobview->Page_Terminate();
?>
