...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_t99_audittrail" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<span<?php echo $Page->datetime->ViewAttributes() ?>><?php echo $Page->datetime->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->script->Visible) { ?>
		<td data-field="script"<?php echo $Page->script->CellAttributes() ?>>
<span<?php echo $Page->script->ViewAttributes() ?>><?php echo $Page->script->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->user->Visible) { ?>
		<td data-field="user"<?php echo $Page->user->CellAttributes() ?>>
<span<?php echo $Page->user->ViewAttributes() ?>><?php echo $Page->user->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->action->Visible) { ?>
		<td data-field="action"<?php echo $Page->action->CellAttributes() ?>>
<span<?php echo $Page->action->ViewAttributes() ?>><?php echo $Page->action->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->table->Visible) { ?>
		<td data-field="table"<?php echo $Page->table->CellAttributes() ?>>
<span<?php echo $Page->table->ViewAttributes() ?>><?php echo $Page->table->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->_field->Visible) { ?>
		<td data-field="_field"<?php echo $Page->_field->CellAttributes() ?>>
<span<?php echo $Page->_field->ViewAttributes() ?>><?php echo $Page->_field->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
