...
if (!function_exists('ReportDbHelper')) {
	...
	function &ReportDbHelper($dbid = "") {
		$dbclass = "crdb_lapkeu_db";
		$dbhelper = new $dbclass();
		return $dbhelper;
	}
}

class crdb_lapkeu_db extends crDbHelper {
...
function Database_Connecting(&$info) {
	...
	} elseif (ewr_CurrentHost () == "lapkeu.selusin.net") { // setting koneksi database untuk komputer server
