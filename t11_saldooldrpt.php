...
<?php include_once "t11_saldooldrptinfo.php" ?>
<?php
...
$t11_saldoold_rpt = NULL; // Initialize page object first

class crt11_saldoold_rpt extends crt11_saldoold {
	...
	// Page object name
	var $PageObjName = 't11_saldoold_rpt';
	...
	function __construct() {
		...
		// Table object (t11_saldoold)
		if (!isset($GLOBALS["t11_saldoold"])) {
			$GLOBALS["t11_saldoold"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t11_saldoold"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 't11_saldoold', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ft11_saldooldrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't11_saldoold');
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ft11_saldooldrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ft11_saldooldrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ft11_saldooldrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[3] = $this->Jumlah->CurrentValue;
		} else {
			$this->id->setDbValue("");
...
// Create page object
if (!isset($t11_saldoold_rpt)) $t11_saldoold_rpt = new crt11_saldoold_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$t11_saldoold_rpt;
...
// Create page object
var t11_saldoold_rpt = new ewr_Page("t11_saldoold_rpt");

// Page properties
t11_saldoold_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = t11_saldoold_rpt.PageID;
</script>
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_t11_saldoold" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Bulan"><div class="t11_saldoold_Bulan"><span class="ewTableHeaderCaption"><?php echo $Page->Bulan->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Bulan">
<?php if ($Page->SortUrl($Page->Bulan) == "") { ?>
		<div class="ewTableHeaderBtn t11_saldoold_Bulan">
			<span class="ewTableHeaderCaption"><?php echo $Page->Bulan->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t11_saldoold_Bulan" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Bulan) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Bulan->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Tahun"><div class="t11_saldoold_Tahun"><span class="ewTableHeaderCaption"><?php echo $Page->Tahun->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Tahun">
<?php if ($Page->SortUrl($Page->Tahun) == "") { ?>
		<div class="ewTableHeaderBtn t11_saldoold_Tahun">
			<span class="ewTableHeaderCaption"><?php echo $Page->Tahun->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t11_saldoold_Tahun" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Tahun) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Tahun->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Jumlah"><div class="t11_saldoold_Jumlah" style="text-align: right;"><span class="ewTableHeaderCaption"><?php echo $Page->Jumlah->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Jumlah">
<?php if ($Page->SortUrl($Page->Jumlah) == "") { ?>
		<div class="ewTableHeaderBtn t11_saldoold_Jumlah" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->Jumlah->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t11_saldoold_Jumlah" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Jumlah) ?>',2);" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->Jumlah->FldCaption() ?></span>
...
<?php include "t11_saldooldrptpager.php" ?>
