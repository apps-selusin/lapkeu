...
define("EWR_PROJECT_ID", "{3CDC6268-D928-4495-B72A-CA5D35EAE344}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "prj_lapkeu", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_lapkeu", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'MV6fc3PhoU61olPK', TRUE); // Random key for encryption
...
define("EWR_TABLE_PREFIX", "{3CDC6268-D928-4495-B72A-CA5D35EAE344}", TRUE);
