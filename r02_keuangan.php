...
$r02_keuangan_php = NULL; // Initialize page object first

class cr02_keuangan_php {
	...
	// Table name
	var $TableName = 'r02_keuangan.php';

	// Page object name
	var $PageObjName = 'r02_keuangan_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'r02_keuangan.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "r02_keuangan_php", $url, "", "r02_keuangan_php", TRUE);
		$this->Heading = $Language->TablePhrase("r02_keuangan_php", "TblCaption"); 
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($r02_keuangan_php)) $r02_keuangan_php = new cr02_keuangan_php();

// Page init
$r02_keuangan_php->Page_Init();

// Page main
$r02_keuangan_php->Page_Main();
...
<?php
$r02_keuangan_php->Page_Terminate();
?>
