...
$t03_barang_view = NULL; // Initialize page object first

class ct03_barang_view extends ct03_barang {
	...
	// Page object name
	var $PageObjName = 't03_barang_view';
...
// Create page object
if (!isset($t03_barang_view)) $t03_barang_view = new ct03_barang_view();

// Page init
$t03_barang_view->Page_Init();

// Page main
$t03_barang_view->Page_Main();
...
var CurrentForm = ft03_barangview = new ew_Form("ft03_barangview", "view");

// Form_CustomValidate event
ft03_barangview.Form_CustomValidate = 
...
<?php
	foreach ($t03_barang_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
<?php echo $t03_barang->Nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_barang->satuan_id->Visible) { // satuan_id ?>
	<tr id="r_satuan_id">
		<td class="col-sm-2"><span id="elh_t03_barang_satuan_id"><?php echo $t03_barang->satuan_id->FldCaption() ?></span></td>
...
<?php echo $t03_barang->satuan_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
