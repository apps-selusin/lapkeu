...
//
// Table class for t07_sekolah
//
class ct07_sekolah extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't07_sekolah';
		$this->TableName = 't07_sekolah';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t07_sekolah`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t07_sekolah', 't07_sekolah', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Nama
		$this->Nama = new cField('t07_sekolah', 't07_sekolah', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nama->Sortable = TRUE; // Allow sort
		$this->fields['Nama'] = &$this->Nama;

		// Alamat
		$this->Alamat = new cField('t07_sekolah', 't07_sekolah', 'x_Alamat', 'Alamat', '`Alamat`', '`Alamat`', 200, -1, FALSE, '`Alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t07_sekolah`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t07_sekolahedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t07_sekolahadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t07_sekolahview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t07_sekolahview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t07_sekolahadd.php?" . $this->UrlParm($parm);
		else
			$url = "t07_sekolahadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t07_sekolahedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t07_sekolahadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t07_sekolahdelete.php", $this->UrlParm());
	}
