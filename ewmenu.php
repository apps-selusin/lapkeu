...
$RootMenu->AddMenuItem(10015, "mi_v01_barang_satuan", $Language->MenuPhrase("10015", "MenuText"), "v01_barang_satuanlist.php", -1, "", AllowListMenu('{239A2A32-109A-412F-A3CB-FF6290C167FC}v01_barang_satuan'), FALSE, FALSE, "");
...
$RootMenu->AddMenuItem(10014, "mri_r055fsubgroup", $Language->MenuPhrase("10014", "MenuText"), "r05_subgroupsmry.php", 10012, "{3CDC6268-D928-4495-B72A-CA5D35EAE344}", AllowListMenu('{3CDC6268-D928-4495-B72A-CA5D35EAE344}r05_subgroup'), FALSE, FALSE, "");
