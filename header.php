...
<?php } ?>
<link rel="shortcut icon" type="image/png" href="<?php echo $EW_RELATIVE_PATH ?>Laporan Keuangan"><link rel="icon" type="image/png" href="<?php echo $EW_RELATIVE_PATH ?>Laporan Keuangan">
