...
define("EW_PROJECT_NAME", "prj_lapkeu", TRUE); // Project name
...
define("EW_RANDOM_KEY", '5G0Sjl9QP47WfQWs', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_lapkeu", "qs" => "`", "qe" => "`");
