...
class ct05_subgroup extends cTable {
	...
	function __construct() {
		...
		// maingroup_id
		$this->maingroup_id = new cField('t05_subgroup', 't05_subgroup', 'x_maingroup_id', 'maingroup_id', '`maingroup_id`', '`maingroup_id`', 3, -1, FALSE, '`maingroup_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
