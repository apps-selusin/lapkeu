...
<?php if ($t05_subgroup->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_t05_subgroup_id" class="<?php echo $t05_subgroup_edit->LeftColumnClass ?>"><?php echo $t05_subgroup->id->FldCaption() ?></label>
		<div class="<?php echo $t05_subgroup_edit->RightColumnClass ?>"><div<?php echo $t05_subgroup->id->CellAttributes() ?>>
<span id="el_t05_subgroup_id">
<span<?php echo $t05_subgroup->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t05_subgroup->id->EditValue ?></p></span>
</span>
...
<?php echo $t05_subgroup->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t05_subgroup->maingroup_id->Visible) { // maingroup_id ?>
	<div id="r_maingroup_id" class="form-group">
		<label id="elh_t05_subgroup_maingroup_id" for="x_maingroup_id" class="<?php echo $t05_subgroup_edit->LeftColumnClass ?>"><?php echo $t05_subgroup->maingroup_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t05_subgroup_edit->RightColumnClass ?>"><div<?php echo $t05_subgroup->maingroup_id->CellAttributes() ?>>
<span id="el_t05_subgroup_maingroup_id">
<input type="text" data-table="t05_subgroup" data-field="x_maingroup_id" name="x_maingroup_id" id="x_maingroup_id" size="30" placeholder="<?php echo ew_HtmlEncode($t05_subgroup->maingroup_id->getPlaceHolder()) ?>" value="<?php echo $t05_subgroup->maingroup_id->EditValue ?>"<?php echo $t05_subgroup->maingroup_id->EditAttributes() ?>>
</span>
