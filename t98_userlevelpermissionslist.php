...
<?php if ($t98_userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	...
	<?php } else { ?>
		<th data-name="userlevelid" class="<?php echo $t98_userlevelpermissions->userlevelid->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t98_userlevelpermissions->SortUrl($t98_userlevelpermissions->userlevelid) ?>',1);"><div id="elh_t98_userlevelpermissions_userlevelid" class="t98_userlevelpermissions_userlevelid">
...
<?php if ($t98_userlevelpermissions->permission->Visible) { // permission ?>
	...
	<?php } else { ?>
		<th data-name="permission" class="<?php echo $t98_userlevelpermissions->permission->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t98_userlevelpermissions->SortUrl($t98_userlevelpermissions->permission) ?>',1);"><div id="elh_t98_userlevelpermissions_permission" class="t98_userlevelpermissions_permission">
