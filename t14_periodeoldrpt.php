...
<?php include_once "t14_periodeoldrptinfo.php" ?>
<?php
...
$t14_periodeold_rpt = NULL; // Initialize page object first

class crt14_periodeold_rpt extends crt14_periodeold {
	...
	// Page object name
	var $PageObjName = 't14_periodeold_rpt';
	...
	function __construct() {
		...
		// Table object (t14_periodeold)
		if (!isset($GLOBALS["t14_periodeold"])) {
			$GLOBALS["t14_periodeold"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t14_periodeold"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 't14_periodeold', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ft14_periodeoldrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't14_periodeold');
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_t14_periodeold\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_t14_periodeold',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ft14_periodeoldrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ft14_periodeoldrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ft14_periodeoldrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if ($opt == 1) { // Get first row
				...
				$this->FirstRowData['TanggalAwal'] = ewr_Conv($rs->fields('TanggalAwal'), 133);
				$this->FirstRowData['TanggalAkhir'] = ewr_Conv($rs->fields('TanggalAkhir'), 133);
				$this->FirstRowData['NamaBulan'] = ewr_Conv($rs->fields('NamaBulan'), 200);
		} else { // Get next row
			$rs->MoveNext();
		}
		if (!$rs->EOF) {
			...
			$this->TanggalAwal->setDbValue($rs->fields('TanggalAwal'));
			$this->TanggalAkhir->setDbValue($rs->fields('TanggalAkhir'));
			$this->NamaBulan->setDbValue($rs->fields('NamaBulan'));
			$this->Val[1] = $this->Bulan->CurrentValue;
			$this->Val[2] = $this->Tahun->CurrentValue;
			$this->Val[3] = $this->TanggalAwal->CurrentValue;
			$this->Val[4] = $this->TanggalAkhir->CurrentValue;
			$this->Val[5] = $this->NamaBulan->CurrentValue;
		} else {
			$this->id->setDbValue("");
			$this->Bulan->setDbValue("");
			$this->Tahun->setDbValue("");
			$this->TanggalAwal->setDbValue("");
			$this->TanggalAkhir->setDbValue("");
			$this->NamaBulan->setDbValue("");
		}
	}
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->NamaBulan->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// TanggalAwal
			$CurrentValue = $this->TanggalAwal->CurrentValue;
			$ViewValue = &$this->TanggalAwal->ViewValue;
			$ViewAttrs = &$this->TanggalAwal->ViewAttrs;
			$CellAttrs = &$this->TanggalAwal->CellAttrs;
			$HrefValue = &$this->TanggalAwal->HrefValue;
			$LinkAttrs = &$this->TanggalAwal->LinkAttrs;
			$this->Cell_Rendered($this->TanggalAwal, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);

			// TanggalAkhir
			$CurrentValue = $this->TanggalAkhir->CurrentValue;
			$ViewValue = &$this->TanggalAkhir->ViewValue;
			$ViewAttrs = &$this->TanggalAkhir->ViewAttrs;
			$CellAttrs = &$this->TanggalAkhir->CellAttrs;
			$HrefValue = &$this->TanggalAkhir->HrefValue;
			$LinkAttrs = &$this->TanggalAkhir->LinkAttrs;
			$this->Cell_Rendered($this->TanggalAkhir, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);

			// NamaBulan
			$CurrentValue = $this->NamaBulan->CurrentValue;
			$ViewValue = &$this->NamaBulan->ViewValue;
			$ViewAttrs = &$this->NamaBulan->ViewAttrs;
			$CellAttrs = &$this->NamaBulan->CellAttrs;
			$HrefValue = &$this->NamaBulan->HrefValue;
			$LinkAttrs = &$this->NamaBulan->LinkAttrs;
			$this->Cell_Rendered($this->NamaBulan, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
		}
	...
	function SetupFieldCount() {
		...
		if ($this->TanggalAwal->Visible) $this->DtlColumnCount += 1;
		if ($this->TanggalAkhir->Visible) $this->DtlColumnCount += 1;
		if ($this->NamaBulan->Visible) $this->DtlColumnCount += 1;
	}
...
// Create page object
if (!isset($t14_periodeold_rpt)) $t14_periodeold_rpt = new crt14_periodeold_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$t14_periodeold_rpt;
...
// Create page object
var t14_periodeold_rpt = new ewr_Page("t14_periodeold_rpt");

// Page properties
t14_periodeold_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = t14_periodeold_rpt.PageID;
</script>
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_t14_periodeold" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Bulan"><div class="t14_periodeold_Bulan"><span class="ewTableHeaderCaption"><?php echo $Page->Bulan->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Bulan">
<?php if ($Page->SortUrl($Page->Bulan) == "") { ?>
		<div class="ewTableHeaderBtn t14_periodeold_Bulan">
			<span class="ewTableHeaderCaption"><?php echo $Page->Bulan->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t14_periodeold_Bulan" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Bulan) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Bulan->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Tahun"><div class="t14_periodeold_Tahun"><span class="ewTableHeaderCaption"><?php echo $Page->Tahun->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Tahun">
<?php if ($Page->SortUrl($Page->Tahun) == "") { ?>
		<div class="ewTableHeaderBtn t14_periodeold_Tahun">
			<span class="ewTableHeaderCaption"><?php echo $Page->Tahun->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t14_periodeold_Tahun" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Tahun) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Tahun->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->TanggalAwal->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="TanggalAwal"><div class="t14_periodeold_TanggalAwal"><span class="ewTableHeaderCaption"><?php echo $Page->TanggalAwal->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="TanggalAwal">
<?php if ($Page->SortUrl($Page->TanggalAwal) == "") { ?>
		<div class="ewTableHeaderBtn t14_periodeold_TanggalAwal">
			<span class="ewTableHeaderCaption"><?php echo $Page->TanggalAwal->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t14_periodeold_TanggalAwal" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->TanggalAwal) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->TanggalAwal->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->TanggalAwal->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->TanggalAwal->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
<?php } ?>
<?php if ($Page->TanggalAkhir->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="TanggalAkhir"><div class="t14_periodeold_TanggalAkhir"><span class="ewTableHeaderCaption"><?php echo $Page->TanggalAkhir->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="TanggalAkhir">
<?php if ($Page->SortUrl($Page->TanggalAkhir) == "") { ?>
		<div class="ewTableHeaderBtn t14_periodeold_TanggalAkhir">
			<span class="ewTableHeaderCaption"><?php echo $Page->TanggalAkhir->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t14_periodeold_TanggalAkhir" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->TanggalAkhir) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->TanggalAkhir->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->TanggalAkhir->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->TanggalAkhir->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
<?php } ?>
<?php if ($Page->NamaBulan->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="NamaBulan"><div class="t14_periodeold_NamaBulan"><span class="ewTableHeaderCaption"><?php echo $Page->NamaBulan->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="NamaBulan">
<?php if ($Page->SortUrl($Page->NamaBulan) == "") { ?>
		<div class="ewTableHeaderBtn t14_periodeold_NamaBulan">
			<span class="ewTableHeaderCaption"><?php echo $Page->NamaBulan->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer t14_periodeold_NamaBulan" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->NamaBulan) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->NamaBulan->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->NamaBulan->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->NamaBulan->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php } ?>
<?php if ($Page->TanggalAwal->Visible) { ?>
		<td data-field="TanggalAwal"<?php echo $Page->TanggalAwal->CellAttributes() ?>>
<span<?php echo $Page->TanggalAwal->ViewAttributes() ?>><?php echo $Page->TanggalAwal->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->TanggalAkhir->Visible) { ?>
		<td data-field="TanggalAkhir"<?php echo $Page->TanggalAkhir->CellAttributes() ?>>
<span<?php echo $Page->TanggalAkhir->ViewAttributes() ?>><?php echo $Page->TanggalAkhir->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->NamaBulan->Visible) { ?>
		<td data-field="NamaBulan"<?php echo $Page->NamaBulan->CellAttributes() ?>>
<span<?php echo $Page->NamaBulan->ViewAttributes() ?>><?php echo $Page->NamaBulan->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "t14_periodeoldrptpager.php" ?>
